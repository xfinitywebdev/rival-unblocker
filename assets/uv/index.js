...
importScripts('uv.config.js'); // Import the UV config
importScripts(__uv$config.sw || 'uv.sw.js'); // Use UV config to determine the path to the service worker script

const sw = new UVServiceWorker(__uv$config); // Pass UV config to UVServiceWorker constructor
